...
pub const Four = struct {
    ...
    pub fn compute(self: Four, dice_numbers: [5]u8) !void {
        ...
        try std.io.getStdOut().writer().print("Chances to get a {d} four-of-a-kind: {d:.2}%\n", .{self.n, probability});
    }
};
